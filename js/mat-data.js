...
const LEGENDARY_MATS = {
	...
	'Dark Cherry Log':      {perception: 3850},
	'Prime Sphongos':       {perception: 3850, collectable: true},
...
const GATHERING_NODES = {
	...
	Labyrinthos_BL2:     new CollectableLocation('Legendary Labyrinthos',      19, 36,  2, 'Sharlayan Hamlet', 'Logging',
	                        ['Dark Cherry Log']),
	Elpis_BL2:           new CollectableLocation('Legendary Elpis',            10, 30,  2, 'The Twelve Wonders', 'Logging',
	                        ['Paldao Log', 'Prime Sphongos']),
	Labyrinthos_BL4:     new CollectableLocation('Legendary Labyrinthos',      28, 11,  4, 'The Archeion', 'Logging',
	                        ['Bayberry', 'Mornveil Tree Bark']),
	UltimaThule_BL4:     new CollectableLocation('Legendary Ultima Thule',     16, 29,  4, 'Reah Tahra', 'Quarrying',
	                        ['Softsilver Ore']),
	Elpis_ML4:           new CollectableLocation('Legendary Elpis',            13,  7,  4, 'Poiten Oikos', 'Quarrying',
	                        ['Rhodium Sand']),
	...
	Elpis_BL6:           new CollectableLocation('Legendary Elpis',            31, 15,  6, 'Anagnorisis', 'Logging',
	                        ['Mempisang Log']),
	Thavnair_BL6:        new CollectableLocation('Legendary Thavnair',         23, 13,  6, 'Yedihmad', 'Quarrying',
	                        ['Maghemite']),
	...
	MareLamentorium_ML8: new CollectableLocation('Legendary Mare Lamentorium', 29, 22,  8, 'Bestways Burrow', 'Mining',
	                        ['Ilmenite', 'Prime Achondrite']),
	Elpis_ML8:           new CollectableLocation('Legendary Elpis',            31, 18,  8, 'Anagnorisis', 'Quarrying',
	                        ['Raw Spodumene']),
	Garlemald_BL10:      new CollectableLocation('Legendary Garlemald',        16, 12,  10, 'Tertium', 'Logging',
	                        ['Field Mustard']),
	...
	MareLamentorium_ML12: new CollectableLocation('Legendary Mare Lamentorium',  25, 23, 12, 'Bestways Burrow', 'Logging',
	                        ['Lovingbloom']),
};